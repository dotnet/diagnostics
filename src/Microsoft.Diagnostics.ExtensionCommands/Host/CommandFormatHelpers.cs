...
namespace Microsoft.Diagnostics.ExtensionCommands
{
    public static class CommandFormatHelpers
    {
        ...
        public static void DisplaySettingService(this CommandBase command)
        {
            ...
            command.Console.WriteLine($"-> Use cDAC: {settingsService.CDacLoadPolicy switch { CDacLoadPolicy.OnlyUseCDac => "true", CDacLoadPolicy.UseLegacyDac => "false", CDacLoadPolicy.PreferCDac => "prefer", _ => "policy (default)" }}");
