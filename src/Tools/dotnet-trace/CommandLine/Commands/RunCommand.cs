...
namespace Microsoft.Diagnostics.Tools.Trace
{
    ...
    {
        delegate Task<int> RunDelegate(CancellationToken ct, IConsole console, string exec, string args, FileInfo output, uint buffersize, string providers, string profile, TraceFileFormat format, TimeSpan duration, string clrevents, string clreventlevel);
        ...
        /// <param name="exec">The file to run and collect the trace from.</param>
        ...
        /// <returns></returns>
        private static async Task<int> Run(CancellationToken ct, IConsole console, string exec, string args, FileInfo output, uint buffersize, string providers, string profile, TraceFileFormat format, TimeSpan duration, string clrevents, string clreventlevel)
        {
            try
            {
        ...
        public static Command RunCommand() =>
            ...
            {
                // Handler
                HandlerDescriptor.FromDelegate((RunDelegate)Run).GetCommandHandler(),
                // Options
                TargetFileOption(),
                ArgumentOption(),
