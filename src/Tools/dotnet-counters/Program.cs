    ...
    internal class Program
    {
        ...
        private static Option RuntimeVersionOption() =>
            new Option(
                ...
                description: "Version of runtime. Supported runtime versions: 6.0, 7.0, 8.0") 
            {
        ...
        private static readonly string[] s_SupportedRuntimeVersions = new[] { "6.0", "7.0", "8.0" };
        ...
        public static int List(IConsole console, string runtimeVersion)
        {
            if (!s_SupportedRuntimeVersions.Contains(runtimeVersion))
            {
                ...
                Console.WriteLine("Supported version strings: 6.0, 7.0, 8.0");
                return 0;
            }
