...
| `SOSHARNESS_HOST_RUNTIME_DIR` | Override the complete runtime directory used to host managed SOS. The directory must contain CoreCLR and `System.Private.CoreLib.dll`. |
