...
namespace Microsoft.Diagnostics.Monitoring.EventPipe.UnitTests
{
    public class AspNetTriggerUnitTests
    {
        ...
        public void TestAspNetRequestCount()
        {
            ...
            SimulatedTraceEvent s1 = generator.CreateEvent(DateTime.UtcNow);

            // These should not trigger anything because they are not included
            SimulatedTraceEvent s2 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(30), "/notIncluded");
            SimulatedTraceEvent s3 = generator.CreateEvent(s2.Timestamp, "/notIncluded");
            SimulatedTraceEvent s4 = generator.CreateEvent(s2.Timestamp, "/notIncluded");

            SimulatedTraceEvent s5 = generator.CreateEvent(s2.Timestamp);

            //Pushes the first event out of sliding window
            SimulatedTraceEvent s6 = generator.CreateEvent(s2.Timestamp + TimeSpan.FromSeconds(40));

            SimulatedTraceEvent s7 = generator.CreateEvent(s6.Timestamp + TimeSpan.FromSeconds(0.5));
        ...
        public void TestAspNetRequestCountExclusions()
        {
            ...
            SimulatedTraceEvent s1 = generator.CreateEvent(DateTime.UtcNow);
            SimulatedTraceEvent s2 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent s3 = generator.CreateEvent(s2.Timestamp);
            SimulatedTraceEvent s4 = generator.CreateEvent(s2.Timestamp);

            SimulatedTraceEvent s5 = generator.CreateEvent(s2.Timestamp, "/notExcluded");
            SimulatedTraceEvent s6 = generator.CreateEvent(s2.Timestamp, "/notExcluded");
            SimulatedTraceEvent s7 = generator.CreateEvent(s6.Timestamp + TimeSpan.FromSeconds(10), "/notExcluded");
        ...
        public void TestAspNetDuration()
        {
            ...
            SimulatedTraceEvent s1 = generator.CreateEvent(DateTime.UtcNow);
            SimulatedTraceEvent e1 = generator.CreateEvent(s1, TimeSpan.FromSeconds(3.1).Ticks);

            SimulatedTraceEvent s2 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e2 = generator.CreateEvent(s2, TimeSpan.FromSeconds(10).Ticks);

            //does not exceed duration
            SimulatedTraceEvent s3 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e3 = generator.CreateEvent(s3, TimeSpan.FromSeconds(1).Ticks);

            //pushes the sliding window past all prevoius events
            SimulatedTraceEvent s4 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromMinutes(5));
            SimulatedTraceEvent e4 = generator.CreateEvent(s4, TimeSpan.FromSeconds(15).Ticks);

            SimulatedTraceEvent s5 = generator.CreateEvent(s4.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e5 = generator.CreateEvent(s5, TimeSpan.FromSeconds(10).Ticks);

            SimulatedTraceEvent s6 = generator.CreateEvent(s4.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e6 = generator.CreateEvent(s6, TimeSpan.FromSeconds(20).Ticks);
        ...
        public void TestAspNetDurationHungRequests()
        {
            ...
            SimulatedTraceEvent s1 = generator.CreateEvent(DateTime.UtcNow);
            SimulatedTraceEvent e1 = generator.CreateEvent(s1, TimeSpan.FromMinutes(1).Ticks);

            SimulatedTraceEvent s2 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e2 = generator.CreateEvent(s2, TimeSpan.FromMinutes(2).Ticks);

            SimulatedTraceEvent s3 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(2));
            SimulatedTraceEvent e3 = generator.CreateEvent(s3, TimeSpan.FromMinutes(3).Ticks);

            SimulatedTraceEvent h1 = generator.CreateCounterEvent(s1.Timestamp + TimeSpan.FromSeconds(15));
        ...
        public void TestAspNetStatus()
        {
            ...
            SimulatedTraceEvent s1 = generator.CreateEvent(DateTime.UtcNow);
            SimulatedTraceEvent e1 = generator.CreateEvent(s1, TimeSpan.FromSeconds(3.1).Ticks, statusCode: 404);

            SimulatedTraceEvent s2 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e2 = generator.CreateEvent(s2, TimeSpan.FromSeconds(10).Ticks, statusCode: 420);
            ...
            //pushes the sliding window past all prevoius events
            SimulatedTraceEvent s4 = generator.CreateEvent(s1.Timestamp + TimeSpan.FromMinutes(5));
            SimulatedTraceEvent e4 = generator.CreateEvent(s4, TimeSpan.FromSeconds(15).Ticks, statusCode: 520);

            SimulatedTraceEvent s5 = generator.CreateEvent(s4.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e5 = generator.CreateEvent(s5, TimeSpan.FromSeconds(10).Ticks, statusCode: 521);

            //does not meet status code
            SimulatedTraceEvent s6 = generator.CreateEvent(s4.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e6 = generator.CreateEvent(s5, TimeSpan.FromSeconds(10).Ticks);

            SimulatedTraceEvent s7 = generator.CreateEvent(s4.Timestamp + TimeSpan.FromSeconds(1));
            SimulatedTraceEvent e7 = generator.CreateEvent(s7, TimeSpan.FromSeconds(20).Ticks, statusCode: 404);
