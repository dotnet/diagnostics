...
namespace Microsoft.Diagnostics.NETCore.Client
{
    public partial class CommonHelper
    {
        ...
        public static string GetTraceePath(string traceeName = "Tracee", string targetFramework = "net5.0")
        {
        ...
        /// </summary>
        public static string GetTraceePathWithArgs(string traceeName = "Tracee", string targetFramework = "net5.0")
        {
            ...
            if (targetFramework.Equals("net5.0", StringComparison.InvariantCultureIgnoreCase))
                return $"--fx-version {CurrentDARCVersion} {traceePath}";
