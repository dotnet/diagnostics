...
namespace Microsoft.Diagnostics.Tools.Trace
{
    public class ProviderParsingTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => ProviderUtils.ToProviders(providerToParse));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => ProviderUtils.ToProviders(providerToParse));
        }
        ...
        {
            Assert.Throws<OverflowException>(() => ProviderUtils.ToProviders(providerToParse));
        }
        ...
        {
            Assert.Throws<FormatException>(() => ProviderUtils.ToProviders(providerToParse));
        }
        ...
        {
            List<EventPipeProvider> parsedProviders = ProviderUtils.ToProviders(providersToParse);
        ...
        {
            Assert.Throws<ArgumentException>(() => ProviderUtils.ToProviders(providersToParse));
        }
        ...
        {
            Assert.Throws<OverflowException>(() => ProviderUtils.ToProviders(providersToParse));
        }
        ...
        {
            Assert.Throws<FormatException>(() => ProviderUtils.ToProviders(providersToParse));
        }
        ...
        public void ProvidersWithComplexFilters_CorrectlyParse()
        {
            ...
            parsedProviders = ProviderUtils.ToProviders(providersToParse);
