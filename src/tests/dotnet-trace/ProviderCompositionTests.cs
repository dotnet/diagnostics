...
namespace Microsoft.Diagnostics.Tools.Trace
{
    public class ProviderCompositionTests
    {
        ...
        public static IEnumerable<object[]> InvalidProviders()
        {
            ...
            yield return new object[] { ":1:1", typeof(ArgumentException) };
            yield return new object[] { "ProviderOne:0x1:UnknownLevel", typeof(ArgumentException) };
            yield return new object[] { "VeryCoolProvider:0x0:-1", typeof(ArgumentException) };
        ...
        {
            yield return new object[] { "ProviderOne:0x1:5:FilterAndPayloadSpecs=\"QuotedValue\",:2:2:key=value,ProviderThree:3:3:key=value", typeof(ArgumentException) };
        ...
        {
            yield return new object[] { new[]{ "MyProvider:::key=value", "MyProvider:::key=value" }, typeof(ArgumentException) };
        }
        ...
        {
            yield return new object[] { Array.Empty<string>(), "gc+bogus", string.Empty, Array.Empty<string>(), typeof(ArgumentException) };
        }
