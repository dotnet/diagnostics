...
namespace Microsoft.Diagnostics.Monitoring.EventPipe
{
    internal class EventLogsPipeline : EventSourcePipeline<EventLogsPipelineSettings>
    {
        ...
        private readonly ILogRecordLogger _logger;
        ...
        public EventLogsPipeline(DiagnosticsClient client, EventLogsPipelineSettings settings, ILogRecordLogger logger)
            : base(client, settings)
        {
        ...
        protected override async Task OnEventSourceAvailable(EventPipeEventSource eventSource, Func<Task> stopSessionAsync, CancellationToken token)
        {
            if (_logger != null)
            {
                await _logger.PipelineStarted(token).ConfigureAwait(false);
            }
            ...
            if (_logger != null)
            {
                ...
                await _logger.PipelineStopped(token).ConfigureAwait(false);
            }
        }
