...
#if defined(__GNUC__) && !defined(_X86_) && !defined(_AMD64_) && !defined(_ARM_) && !defined(_ARM64_) && !defined(_MIPS64_)
#error The Volatile type is currently only defined for GCC when targeting x86, AMD64, ARM, ARM64 or MIPS64 CPUs
#endif
