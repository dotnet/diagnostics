...
#if !defined(HOST_ARM) && defined(TARGET_ARM) // Non-HOST_ARM Host managing HOST_ARM related code
...
#elif defined(HOST_AMD64) && defined(TARGET_ARM64)  // Host amd64 managing HOST_ARM64 related code
